...
export default function Login() {
  ...
  const register = (e) => {
    ...
    auth
      ...
      .then((auth) => {
        //successfully created the user with email and passowrd
        console.log(auth);
        //if auth is successfull redirect/push to home page
        if (auth) {
          history.push("/");
        }
      })
    ...
    <div className="login">
      ...
      <div className="login_container">
        ...
        <p>
          ...
          Please see our Privacy Notice and Cookies Notice and Interest based
          ads
        </p>
